      ...
      <main className="section-pad">
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          ...
          <div className="lg:pt-6">
            ...
            <p className="mt-8 max-w-xl text-lg leading-relaxed text-ploy-text-secondary">
              {chef.bio}
            </p>
            <p className="mt-4 text-sm tracking-[0.04em] text-ploy-text-secondary">
              {chef.specialties}
            </p>
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-2">
              {chef.included.map((item) => (
                <span key={item} className="flex items-center gap-2 text-sm">
                  <Check
                    size={15}
                    className="text-ploy-accent-tertiary"
                    aria-hidden="true"
                  />
                  {item}
                </span>
            ...
            <Link
              ...
              className="btn btn-primary mt-10 min-h-12 px-7"
            >
              Request this chef
            </Link>
          </div>
